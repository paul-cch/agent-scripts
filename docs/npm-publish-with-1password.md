...
Set the exact vault/item refs for Paul's npm account before running this flow.
...
buffers and pasting. Set the exact vault/item refs for the npm account first.
