...
- Pick bundle id: `com.paulcouach.<appname>` unless the target repo already has a different product namespace (no uppercase, no spaces).
- Appcast URL: `https://raw.githubusercontent.com/<owner>/<Repo>/main/appcast.xml`
