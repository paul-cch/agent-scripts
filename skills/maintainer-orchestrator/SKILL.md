...
- Own repositories the user explicitly assigns, plus repositories where local repo instructions identify the user as maintainer.
- Do not infer exclusions from GitHub organization names. Follow the user's current instruction, repo `AGENTS.md`, and live repository state.
